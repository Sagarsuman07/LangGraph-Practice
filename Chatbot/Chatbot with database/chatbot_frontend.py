...
st.sidebar.markdown("This is a chatbot built using Langgraph and Langchain. It uses the Google Gemma 2.2B model for generating responses.")
...
if user_input:
    ...
    # now send the message to the chatbot and get the response
